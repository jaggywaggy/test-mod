...
public class TestMod
{
    ...
    public static final DeferredBlock<Block> EXAMPLE_BLOCK = BLOCKS.registerSimpleBlock("test_block", BlockBehaviour.Properties.of());
    ...
    public static final DeferredItem<Item> EXAMPLE_ITEM = ITEMS.registerSimpleItem("test_item", new Item.Properties().food(new FoodProperties.Builder()
